...
const BentoCardGrid: React.FC<{
  ...
  <div
    className="bento-section grid gap-2 p-3 max-w-[54rem] select-none relative w-full"
              ...
              return (
                ...
                >
                  ...
                  <div className="card__content flex flex-col relative text-white">
                    <h3 className={`card__title font-semibold text-lg tracking-tight m-0 mb-1 ${textAutoHide ? 'text-clamp-1' : ''}`}>
                      {card.title}
                    </h3>
                    <p
