...
const defaultNavigationLinks: Navbar02NavItem[] = [
...

  {
    ...
    type: 'icon',
    items: [
      { href: '/edukasi/artikel', label: 'Artikel Edukasi', icon: 'BookOpenIcon' },
      { href: '/edukasi/pencegahan', label: 'Pencegahan', icon: 'LifeBuoyIcon' },
      { href: '/edukasi/tentang-tbc', label: 'Tentang TBC', icon: 'InfoIcon' },
    ],
  },
];
                  ...
                  <NavigationMenuItem key={index}>
                    {link.submenu ? (
                      <>
                        ...
                        <NavigationMenuContent>
                          {link.type === 'description' && link.label === 'Screening' ? (
